...
import DietJourneyCard from './DietJourneyCard'
...
const Dashboard = ({ user, data, setData, loading }: DashboardProps) => {
  ...
  const upcomingDays = useMemo(() => {
    ...
    return rows
  }, [daysOnDiet, data.weekSchedule, data.activePlanId, data.dayPlans]) // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [israelTodayKey, todayConsumed, data.dailyLogs]) // eslint-disable-line react-hooks/exhaustive-deps
